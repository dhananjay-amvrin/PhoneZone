...
public class User {
	...
	@FindBy(xpath = "//h3[@class='title1'and contains(text(), 'Add User')]")
	...
	private void selectWholeseller(String wholeseller) {
		...
		if (wholeseller != null && !wholeseller.isEmpty())
			listbox.selectByValue(wholeseller);
	}
	...
	public String editUser(String firstName, String lastName, String email, String password, String phoneNumber,
			String userRole, String wholeseller, String status) {
		StringBuffer errorMessages = new StringBuffer();
		this.setFirstName(firstName);
		this.setLastName(lastName);
